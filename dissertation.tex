...
different tracking configuration are evaluated: using the vorticity at the \SI{995}{hPa} and
\SI{850}{hPa} pressure levels and using the original resolution data, and data downscaled to two and
...
chosen as the pressure level to use due to\dots
