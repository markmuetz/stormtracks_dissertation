...
\begin{center}
\textbf{Word count:} 12250 % 11094 + 1156 (captions) 26/08/14 14:19
\end{center}
...
run, and the results gathered, before deleting that decade's data and moving onto the next one.
...
\ref{sec:matching}). The formula for vorticity, $\omega$, is given by:
...
\ref{sec:matching}). A discussion of other tracking algorithms can be found in Section
...
holland2007heightened}. However, although they both use best tracks information to work draw their
