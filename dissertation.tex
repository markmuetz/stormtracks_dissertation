...
\begin{center}
\textbf{Word count:} 10427 % 9180 + 1247 (captions) 26/08/14 14:19
\end{center}
...
The 20\ts{th} Century Reanalysis Project and the IBTrACS projects are both excellent resources, 
with the first providing over 1.3 terabytes of data.
...
identified, and 73\% of predicted hurricanes that turn out to be actual hurricanes. During the
course of this study, collecting more fields was a primary way of helping to improve these numbers,
with the temperature fields having good discriminatory power between hurricanes and non-hurricanes.
However, there were many fields that I would have liked to include but could not, due to constraints
as to what is easily available to download from the 20CR portal for each ensemble member. These
include the TODOWRITE.
