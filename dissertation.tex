...
\begin{center}
\textbf{Word count:} 6116 % 21/08/14 9:00
\end{center}
...
as giving me some pointers on extra-tropical transitions. % TODOIMPROVE: CLUMSY
...
Center \parencite{jarvinen1984tropical}. These databases suffer from some problems when going into
the middle and early 20\ts{th} century, such as the lack of satellite data before the 1970s, and the
lack of reliable aeroplane reconnaissance data before the mid 1940s \parencite{chang2007number}.
...
with variables such as the longitudinal and latitudinal wind speeds at the \SI{995}{hPa} pressure
level and the temperature at the \SI{850}{hPa} pressure level recorded.
...
studies that take this approach are \textcite{TODOCITE multiple}. 
...
be found, such as whether it undergoes an extra tropical transition \parencite{hart2001climatology}.
This is the approach taken by \textcite{hodges1994general, hodges1999adaptive,
...
\ref{sec:TODOREF}, where a comparison is made between a derived track and a best track, the
surprising aspect is the degree to which the pressures do not correlate, which suggests that the
IBTrACS best track pressure data is not solely responsible for the pressure along the track's
course.
...
% TODOFIG showing Galveston Hurricane.
...
% TODOWRITE: switch to cumoveroverlap as it is much easier to describe.
...
% TODOFIG: Comparison of wins/losses of different tracking configurations.
...
% TODOFIG: plot showing poor correlation between Katrina derived and best.
...
% TODOFIG: Venn diagram

% TODOTABLE: error matrix
...
% TODOFIG: Plot of sens/PPV for varying vorticity threshold.
...
% TODOWRITE: Explain feature scaling.
...
% TODOFIG: ROC and sens vs PPV (training)
% TODOFIG: ROC and sens vs PPV (validation)
