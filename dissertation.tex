...
% \usepackage[backend=biber,sorting=nyt,style=authoryear-ibd]{biblatex}
...
Talking to Josh Studholme helped to provide context for the field and ideas for analysis. % CLUMSY
...
According to \parencite{yin2012individual} it has been established that \dots
However \textcite{marengo2010future} have found that \dots
Section text.
