...
% Turns off page numbering! Do not leave this line in!!!
...
\begin{center}
\textbf{Word count:} 11986 % 28/08/14 20:33
\end{center}
...
% Talk about the primary difference: the existence of best tracks databases.
...
% CULLED
% indeed there are ``no new storms in the NA or EP basins'' in the IBTrACS database.
...
% val: 0.6312659737604361, 0.6053164722412835, 0.011579432259338635
        \multicolumn{1}{|c|}{LDA} & 0.618 & 0.612 & \SI{12.08e-3}{} & 0.631 & 0.605 & \SI{11.58e-3}{} \\
...
% val: 0.7647299369568922, 0.5755725973992665, 0.015864258395292107
        \multicolumn{1}{|c|}{QDA} & 0.748 & 0.596 & \SI{15.69e-3}{} & 0.765 & 0.576 & \SI{15.86e-3}{} \\
...
% val: 0.6369398534673709, 0.7170643750479552, 0.007070274695750501
        \multicolumn{1}{|c|}{SGD} & 0.637 & 0.739 & \SI{6.97e-3}{} & 0.640 & 0.717 & \SI{7.07e-3}{} \\
...
% CULLED!
% Whilst it is possible to obtain these fields, the only
% way to do this is to download the entire state of the atmosphere as represented by the GCM, which
% would be prohibitively time consuming for this project, although these extra fields would have
% probably helped the classification procedure.
