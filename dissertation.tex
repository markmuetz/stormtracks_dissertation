...
shown in the first correlation plot, these series are very well correlated. The slope is less than
...
the post-1944 period. For reference the pre-1944 period has a slope of TODOCHECK and a y-intercept
of TODOCHECK. The post-1944 period has a slop of TODOCHECK ad a y-intercept of TODOCHECK.
...
positive y-intercept and the slope which is greater than unity. Reasons for this are discussed in
Section TODOREF. In the next era, the Panama era, the slope is slightly below unity, and the
y-intercept is small and positive, which means that the two time series are well matched. The most
surprising era is the aircraft reconnaissance era, for which the slope is substantially less than
...
to why this might be are discussed in Section TODOREF.  Finally, in the satellite era, the slope is
...
\begin{table}[ht!]
    ...
    \begin{tabular}{ l | l l l l }
        ...
        Era & slope & $p$ value & slope & $p$ value \\
        \hline
        pre-Panama Canal & -4.93 & 0.018 & -5.41 & 0.013 \\
        Panama Canal & 0.41 & 0.768 & -0.81 & 0.513 \\
        Aircraft & 1.82 & 0.391 & 0.41 & 0.768 \\
        Satellite & 1.07 & 0.190 & 2.48 & 0.001 \\
    \end{tabular}
    \caption{}
...
Canal (1890 - 1914) era for hurricane frequencies for best track and estimated track numbers both
