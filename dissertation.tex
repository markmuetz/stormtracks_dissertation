...
% Figure XX: progression from raw u/v fields to vorticity to downscaled vorticity.
\begin{figure}[hbp]
    \centering
...
% Figure XX: 2x2 showing vorticity + maxima/ pressure + minima.
\begin{figure}[hbp]
    \centering
...
% Figure TODO XX1: Individual ensemble member/best track match.
\begin{figure}[hbp]
    \centering
...
% Figure TODO XX2: 6x configuration plots for Hurricane Katrina.
\begin{figure}[hbp]
    \centering
