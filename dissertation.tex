...
% TODO: Need to mention supervised/unsupervised machine learning. In fact, need to mention machine
%learning full stop!
% TODO: mention fields I have collected are termed features in machine learning terminology.
% TODO: mention that CDPs are equivalent to samples in machine learning terminology.
...
although there is a trade-off between these two metrics, as shown in Figure TODO.
...
classification of data where a gold standard is available. \textcite{TODO} gives a full account of
...
large number of samples. On average, there were TODO samples per year, leading to a total sample
size of TODO million samples. This training dataset was used as a way of picking optimum values for
...
independent. It had a similar number of samples as the training dataset: TODO million samples.
